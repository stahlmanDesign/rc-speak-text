...
var SpeakText = function (_React$Component) {
  _inherits(SpeakText, _React$Component);

  function SpeakText(props) {
    _classCallCheck(this, SpeakText);

    var _this = _possibleConstructorReturn(this, (SpeakText.__proto__ || Object.getPrototypeOf(SpeakText)).call(this, props));

    if ('speechSynthesis' in window) {
      _this.speech = _this.init();
    } else {
